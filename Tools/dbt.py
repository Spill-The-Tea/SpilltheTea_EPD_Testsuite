...
# A simple Python script to Analyze EPD TestSuites automatically
# E.g. Usage in command line:
#       python dbt.py --movetime 1000 --threads 3 ./stockfish path/to/file.epd
# Python Script Taken from mcostalba's PoorFish Repository:
# https://github.com/mcostalba/PoorFish
...
def run_session(args, engine):
    ...
    for pos in epd:
        ...
        print("{}/{}\t{}\t{}\t{}".format(cnt, total, pos, pretty(score1), bestmove))
        if bestmove == san:
...
if __name__ == "__main__":
    ...
    p.add_argument("--threads", help="Number of threads", type=int, default=2)
